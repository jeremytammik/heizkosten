...
const regex_valid_person_id = /^[0-9a-z_]{1,30}$/; // non-empty lowercase alphanumeric with underscore max 30 length
...
const regex_valid_telephone_numbers = /^[0-9\+][0-9\/\- \,\+]{4,60}$/;
const regex_valid_apartment_id = /^[0-9]{3}-[0-9]{2}-[0-9]{2}$/;
const regex_valid_contract_id = /^[0-9]{3}-[0-9]{2}-[0-9]{2}-[0-9]{2,4}$/;
